...
CREATE TABLE `videojuego` (
  ...
  `director` longtext COLLATE utf8mb4_unicode_ci COMMENT '(DC2Type:array)',
  `genero` longtext COLLATE utf8mb4_unicode_ci COMMENT '(DC2Type:array)',
  `fecha_publicacion` varchar(4) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `desarrollador` longtext COLLATE utf8mb4_unicode_ci COMMENT '(DC2Type:array)',
  `descripcion` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `slug` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_AA5E6DFA989D9B62` (`slug`)
...
-- Dump completed on 2022-11-29  8:12:41
