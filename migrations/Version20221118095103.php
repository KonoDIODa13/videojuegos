 ...
 */
final class Version20221118095103 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE lista_juegos ADD videojuego_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE lista_juegos DROP videojuego_id');
    }
}
