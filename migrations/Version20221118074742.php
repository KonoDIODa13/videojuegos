 ...
 */
final class Version20221118074742 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE lista_videojuegos ADD CONSTRAINT FK_9F0B3C1E7EB2C349 FOREIGN KEY (id_usuario_id) REFERENCES usuario (id)');
        $this->addSql('ALTER TABLE lista_videojuegos ADD CONSTRAINT FK_9F0B3C1E3CBA8BE0 FOREIGN KEY (id_videojuego_id) REFERENCES videojuego (id)');
    }
