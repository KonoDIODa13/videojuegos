 ...
 */
final class Version20221122084903 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE lista_juegos (id INT AUTO_INCREMENT NOT NULL, usuario_id INT NOT NULL, videojuego_id INT NOT NULL, INDEX IDX_F6AD149B82925A85 (videojuego_id), INDEX IDX_F6AD149BDB38439E (usuario_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
